...
function library:CreateWindow(text)
	...
	ScrollingFrame.Position = UDim2.new(-0.029442871, 0, -0.0336879268, 0)
	ScrollingFrame.Size = UDim2.new(0, 287, 0, 228)
	...
	function EpicLibrary:CreateSlider(text, minvalue, maxvalue, callback)
	...
	function EpicLibrary:CreateLabel(text)
		...
		Label.Size = UDim2.new(0, 279, 0, 40)
		Label.Image = "rbxassetid://2790390993"
		Label.ImageColor3 = Color3.fromRGB(35, 35, 35)
		Label.ScaleType = Enum.ScaleType.Slice
		Label.SliceCenter = Rect.new(16, 16, 240, 240)
